...
export const Footer: React.FC = () => {
    return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div>
          <h3 className="text-lg font-bold text-white mb-4">AI Blog Writer</h3>
          <p className="text-gray-300">Create amazing blog content with the power of AI. Save time and boost your content quality.</p>
        </div>
      ...
      <div className="border-t border-gray-700 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center">
        <p className="text-gray-400 mb-4 md:mb-0">© 2025 AI Blog Writer. All rights reserved.</p>
